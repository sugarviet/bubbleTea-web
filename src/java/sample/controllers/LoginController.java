...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<OrderDetail> orderDetailList = dao.getListOrderDetail();
            ...
            if (user != null) {
                ...
                session.setAttribute("ORDER_DETAIL_LIST", orderDetailList);
                ...
                if (user.getRoleID().equals("AD")) {
                    ...
                    session.setAttribute("ERROR_MSG", "YOUR ROLE IS NOT SUPPORT");
                }
            }
